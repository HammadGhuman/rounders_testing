...
} from "@/util/item-sub-category"; // Make sure to replace this with the correct import
...
function UpdateCategoryPage({
  ...
  const { data, isLoading: isLoadingQ } = useQuery(["get-sub-category"], () =>
    getItemSubCategory({ id: params.id })
  );

  const { mutate, isLoading } = useMutation(updateItemSubCategory, {
    onSuccess(data, variables, context) {
      console.log(data);
      if (data.status === 201) {
        toast.success("Sub Category Updated Successfully");
        router.push("/admin/item-sub-category");
      }
    },
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center">
        ...
        >
          <Title color="yellow">Update Item Sub Category</Title>
          <div className="mt-10">
