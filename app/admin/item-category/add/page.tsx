...
import { createItemCategory } from "@/util/item-category"; // Make sure to replace this with the correct import
...
function CategoryPage() {
  ...
  const { mutate, isLoading } = useMutation(createItemCategory, {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center">
        <Card decoration="left" decorationColor="red" className="max-w-md mt-10">
          <Title color="yellow">Add Item Category</Title>
          <div className="mt-10">
